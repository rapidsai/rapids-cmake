...
The file generated by :cmake:command:`rapids_cmake_write_version_file` holds the full version,
the separate components, and comparison helpers for the `X.Y.Z` version string set by the CMake
:cmake:command:`project <cmake:command:project>` call as C++ defines.
...
- #define <PREFIX>_VERSION "X.Y.Z" # Unless ``NO_COMBINED_VERSION_MACRO`` is specified
...
function(rapids_cmake_write_version_file file_path)
  ...
  set(options NO_COMBINED_VERSION_MACRO)
  ...
  # The combined version string is opt-out, as projects may already define <PREFIX>_VERSION
  # themselves with a different meaning.
  set(_RAPIDS_WRITE_VERSION_STRING "")
  if(NOT _RAPIDS_NO_COMBINED_VERSION_MACRO)
    set(version_string_template
        [=[

#ifndef @_RAPIDS_PREFIX@_VERSION
#define @_RAPIDS_PREFIX@_VERSION "@_RAPIDS_WRITE_MAJOR@.@_RAPIDS_WRITE_MINOR@.@_RAPIDS_WRITE_PATCH@"
#endif
]=])
    string(CONFIGURE "${version_string_template}" _RAPIDS_WRITE_VERSION_STRING @ONLY)
  endif()
