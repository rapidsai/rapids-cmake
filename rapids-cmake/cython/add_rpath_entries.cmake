...
function(rapids_cython_add_rpath_entries)
  ...
  foreach(path IN LISTS _RAPIDS_CYTHON_PATHS)
    ...
    list(APPEND cleaned_paths "\$ORIGIN/${path}")
  endforeach()

  get_property(targets GLOBAL PROPERTY "rapids_cython_associations_${_RAPIDS_CYTHON_TARGET}")
  list(JOIN cleaned_paths ";" cleaned_paths)
  if(targets)
    foreach(target IN LISTS targets)
      get_target_property(current_rpath ${target} INSTALL_RPATH)
      set_target_properties(${target} PROPERTIES INSTALL_RPATH "${current_rpath};${cleaned_paths}")
    endforeach()
  endif()
