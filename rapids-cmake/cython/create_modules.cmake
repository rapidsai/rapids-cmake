...
function(rapids_cython_create_modules)
  ...
  foreach(cython_filename IN LISTS RAPIDS_CYTHON_SOURCE_FILES)
    # Normalize file paths to be relative to the current directory. cmake_path(NORMAL_PATH
    # cython_filename) cmake_path(IS_ABSOLUTE cython_filename is_absolute) if(is_absolute)
    # cmake_path(RELATIVE_PATH cython_filename) endif()

    # Generate a reasonable module name.
    cmake_path(REMOVE_EXTENSION cython_filename OUTPUT_VARIABLE cython_module)
    # file(TO_CMAKE_PATH "${cython_module}" cython_module) string(REPLACE "/" "_" cython_module
    # "${cython_module}")
