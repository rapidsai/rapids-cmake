...
rapids_export_find_package_root(BUILD RMM [=[${CMAKE_CURRENT_LIST_DIR}/fake/build/path]=]
                                EXPORT_SET test_set)
rapids_export_write_dependencies(build test_set
                                 "${CMAKE_CURRENT_BINARY_DIR}/build_export_set.cmake")

rapids_export_find_package_root(BUILD RMM "/bad/install/path" EXPORT_SET ${unknown_var}) # ignored
rapids_export_find_package_root(BUILD RMM "/bad/install/path2" EXPORT_SET test_set
                                CONDITION unknown_var) # ignored

# Parse the `build_export_set.cmake` file for correct escaped args to
# `rapids_export_find_package_root` calls
...
rapids_export_find_package_root(INSTALL RMM "/bad/install/path" EXPORT_SET test_set
                                CONDITION to_install) # ignored

rapids_export_find_package_root(install PKG2 "/pkg2/install/path" EXPORT_SET test_set)
rapids_export_write_dependencies(INSTALL test_set
