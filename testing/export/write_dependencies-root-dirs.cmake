...
rapids_export_find_package_root(
  BUILD
  RMM
  [=[${CMAKE_CURRENT_LIST_DIR}/fake/build/path]=]
  EXPORT_SET test_set
)
...
if(is_found EQUAL -1)
  message(
    FATAL_ERROR
    "rapids_export_write_dependencies(BUILD) failed to preserve variables in the directory path to rapids_export_find_package_root"
  )
endif()
...
if(is_found EQUAL -1)
  message(
    FATAL_ERROR
    "rapids_export_write_dependencies(INSTALL) failed to record all RMM_ROOT rapids_export_find_package_root commands"
  )
endif()
...
if(is_found EQUAL -1)
  message(
    FATAL_ERROR
    "rapids_export_write_dependencies(INSTALL) failed to record all PKG2 rapids_export_find_package_root commands"
  )
endif()
