...
rapids_export_cpm(
  ...
  CPM_ARGS
    ...
    VERSION 1.0
    OPTIONS "FAKE_PACKAGE_OPTION_A TRUE" "FAKE_PACKAGE_OPTION_B FALSE"
)
...
file(
  READ "${CMAKE_BINARY_DIR}/rapids-cmake/test_export_set/build/cpm_FAKE_CPM_PACKAGE.cmake"
  contents
)
...
file(
  READ "${CMAKE_BINARY_DIR}/rapids-cmake/test_export_set/install/cpm_FAKE_CPM_PACKAGE.cmake"
  contents
)
string(FIND "${contents}" "${to_match_string}" is_found)
if(is_found EQUAL -1)
