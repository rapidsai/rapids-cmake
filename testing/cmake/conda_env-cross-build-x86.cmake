...
if(NOT "$<HOST_LINK:SHELL:LINKER:-rpath-link=$ENV{PREFIX}/targets/x86_64-linux/lib>" IN_LIST
   link_options)
...
set(correct_list "placeholder" "env_1" "env_2" "$ENV{PREFIX}/targets/x86_64-linux" "$ENV{PREFIX}"
                 "$ENV{BUILD_PREFIX}")
