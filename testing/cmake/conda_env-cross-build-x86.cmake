...
if(
  NOT
    "$<HOST_LINK:SHELL:LINKER:-rpath-link=$ENV{PREFIX}/targets/x86_64-linux/lib>"
      IN_LIST
      link_options
)
  message(
    FATAL_ERROR
    "Expected rpath-link=env{PREFIX}/targets/x86_64-linux/ to be in the link options of `conda_env`"
  )
endif()
...
set(
  ...
  "env_1"
  "env_2"
  "$ENV{PREFIX}/targets/x86_64-linux"
  "$ENV{PREFIX}"
  "$ENV{BUILD_PREFIX}"
)
set(
