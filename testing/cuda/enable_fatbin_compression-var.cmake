...
foreach(suffix mode option IN ZIP_LISTS name_suffix modes compile_options)
  foreach(var IN ITEMS not_yet_${suffix} exists_${suffix})
    ...
    if(NOT ${var} MATCHES "--compress-mode=${option}")
      message(
        FATAL_ERROR
        "${var} missing the proper compress-mode flag of ${option} instead has ${compile_opts}"
      )
    endif()
  endforeach()
  ...
  if(NOT exists_${suffix} MATCHES "-extra-flag")
    message(
      FATAL_ERROR
      "rapids_cuda_enable_fatbin_compression cleared existing values in a variable"
    )
  endif()
endforeach()
...
foreach(var IN ITEMS not_yet exists)
  ...
  if(
    ...
    AND NOT ${var} MATCHES "--compress-mode"
  )
