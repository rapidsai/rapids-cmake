...
if(NOT fixtures_setup STREQUAL "resource_spec")
  message(
    FATAL_ERROR
    "generate_resource_spec FIXTURES_SETUP property should be set to \"resource_spec\""
  )
endif()
...
if(NOT grsf STREQUAL "${CMAKE_CURRENT_BINARY_DIR}/resource_spec.json")
  message(
    FATAL_ERROR
    "generate_resource_spec FIXTURES_SETUP property should be set to \"${CMAKE_CURRENT_BINARY_DIR}/resource_spec.json\""
  )
endif()
