...
if(NOT CTEST_RESOURCE_SPEC_FILE STREQUAL "sentinel file")
  message(
    FATAL_ERROR
    "CTEST_RESOURCE_SPEC_FILE shouldn't be modified by calling rapids_test_generate_resource_spec"
  )
endif()
...
if(NOT TEST generate_resource_spec)
  message(
    FATAL_ERROR
    "rapids_test_generate_resource_spec failed to create the generate_resource_spec test"
  )
endif()
