...
if(NOT build_patch_only STREQUAL "BUILD_PATCH_ONLY")
  message(
    FATAL_ERROR
    "rapids_cpm_generate_patch_command generated wrong arguments for pkg_with_only_build_patches"
  )
endif()
...
if(DEFINED build_patch_only)
  message(
    FATAL_ERROR
    "rapids_cpm_generate_patch_command generated wrong arguments for pkg_with_non_build_patch"
  )
endif()
